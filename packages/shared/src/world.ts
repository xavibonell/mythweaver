 ...
 */
export const BUILDING_TYPES = ['house', 'shop', 'tavern', 'temple', 'smithy', 'inn', 'general_store', 'cathedral', 'jail', 'vault', 'keep', 'library', 'armory', 'barracks', 'guildhall', 'goblin_warren', 'manor'] as const;
