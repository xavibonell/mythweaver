...
const BUILDING_TYPES = ['tavern', 'temple', 'smithy', 'shop', 'house', 'inn', 'general_store', 'cathedral', 'jail', 'vault', 'keep', 'library', 'armory', 'barracks', 'guildhall', 'goblin_warren', 'manor'] as const;
