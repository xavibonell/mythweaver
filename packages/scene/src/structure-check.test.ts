...
const BUILDING_TYPES = ['house', 'tavern', 'temple', 'smithy', 'shop', 'inn', 'general_store', 'cathedral', 'jail', 'vault', 'keep', 'library', 'armory', 'barracks', 'guildhall', 'goblin_warren', 'manor'] as const;
...
describe('structure invariants — furniture-aware reachability (deadPocket): the carve clears every nook it can', () => {
  ...
  for (const t of ['house', 'temple', 'smithy', 'cathedral', 'jail', 'vault', 'library', 'armory', 'barracks', 'guildhall', 'goblin_warren'] as const) {
